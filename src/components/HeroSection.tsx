...
const HeroSection = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-kiki-purple-50 via-white to-kiki-blue-50 py-20 lg:py-32">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 text-center lg:text-left animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <Button size="lg" className="bg-kiki-purple-600 hover:bg-kiki-purple-700 hover-scale">
                Explore Programs
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
              <Button size="lg" variant="outline" className="border-kiki-purple-600 text-kiki-purple-600 hover:bg-kiki-purple-50 hover-scale">
                Take Career Test
              </Button>
            </div>
